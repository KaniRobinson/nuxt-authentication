<template>
    <div class="flex mb-4">
        <div class="w-full bg-white border border-grey p-5 rounded">
            <h1 class="mb-5">Resend Confirmation</h1>
            <form class="w-full" @submit.prevent="resend">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <nuxt-link to="/login" class="no-underline inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker">Already Confirmed?</nuxt-link>
                </div>
            </form>
        </div>
    </div>
