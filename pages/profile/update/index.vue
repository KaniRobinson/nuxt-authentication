        ...
        <div v-if="!meLoading && me.id" class="w-full bg-white border border-grey p-5 rounded">
            ...
            <form class="w-full" @submit.prevent="update">
                ...
                <div class="flex items-center justify-between">
                    <hr>
                    <button :disabled="updateLoading" class="bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">{{ updateLoading ? 'Loading' : 'Update' }}</button>
                </div>
            </form>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapTwoWayState('user', {
                first_name: 'setUpdateFirstName',
                last_name: 'setUpdateLastName',
                password: 'setUpdatePassword',
                password_confirmation: 'setUpdatePasswordConfirmation',
                email: 'setUpdateEmail'
            }),
        },
